    ...
    <div class="flex flex-col md:flex-row justify-between">
        <div class="flex gap-2">
            <div class="relative text-gray-500 focus-within:text-gray-900 mb-4">
                ...
                <!-- Input Field -->
                <input type="text" id="default-search" v-model="query.Search" @keydown.enter="getListOfSharedDocuments"
            ...
            <button @click="getListOfSharedDocuments"
        ...
        <div>
            <div class="relative inline-block mr-4 mb-2">
                <select id="dropdown"
                    ...
                    v-model="query.Status" @change="getListOfSharedDocuments" @focus="isStatusOpen = true"
                ...
                <div v-if="!query.Status" class="absolute inset-y-0 right-2 flex items-center text-gray-500">
                    <svg :class="{ 'rotate-180': isStatusOpen }" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <thead>
                                <tr class="bg-gray-50">
                                    ...
                                    <th @click="sortBy('Status')"
                                        ...
                                        <div class="flex items-center gap-1">
                                            <span>Status</span>
                                            <SortIcon :active="query.SortBy === 'Status'"
                                                :descending="query.IsDescending" />
                                        </div>
                                    </th>
...
import { getListOfSharedDocuments, generatePagination,changePage,totalEntries,totalPages,query,loading,forms,sortBy, changePageSize } from "~/js/fetchSharedDocuments";
import {
    fetchCanAccess,
    canEdit,
} from "~/js/fetchMenu";
...
function editDocumnet(id) {
    localStorage.setItem("sharedocumentId", encryptData(id));
    router.push("/main/activity/639134769128106649/edit")
