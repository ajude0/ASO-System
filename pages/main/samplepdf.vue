<template>
  <div class="container mx-auto p-6 max-w-4xl">
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div>
          ...
          <div class="mb-6">
            ...
            <div v-if="signaturePreview" class="mt-3">
              ...
              <img :src="signaturePreview" class="border border-blue-300 rounded p-2 max-h-20" alt="Your signature preview" />
            </div>
          </div>
            ...
            <div v-else class="space-y-3">
              ...
              >
                <div class="flex items-start gap-3">
                  <img
                    :src="sig.imageSrc"
                    class="w-16 h-16 object-contain border rounded bg-gray-50"
                  ...
                  <div class="flex-1 text-xs">
                    ...
                    <p v-if="sig.documentId" class="text-gray-400 text-xs">Doc ID: {{ sig.documentId }}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div v-if="savedUserSignature" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        ...
        <details class="mt-3">
          ...
          <pre class="mt-2 p-3 bg-gray-100 rounded text-xs overflow-auto">{{ JSON.stringify(savedUserSignature, null, 2) }}</pre>
        </details>
      </div>
      ...
      <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <ul class="text-sm text-blue-700 space-y-1 list-disc list-inside">
          <li><strong>Pre-placed signatures</strong> (gray borders) are loaded from database and displayed on PDF - they cannot be moved</li>
          <li><strong>Your signature</strong> (blue border) is draggable - position it anywhere you want</li>
    ...
    <!-- PDF Signature Modal -->
    <DraggableSignaturePdf
      :isOpen="isModalOpen"
      :pdfFile="pdfFile"
      :signatureFile="signatureFile"
      :prePlacedSignatures="prePlacedSignatures"
