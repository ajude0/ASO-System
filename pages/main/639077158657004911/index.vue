    ...
    <div class="flex flex-col md:flex-row justify-between">
        <div class="flex gap-2">
            <div class="relative text-gray-500 focus-within:text-gray-900 mb-4">
                ...
                <!-- Input Field -->
                <input type="text" id="default-search" v-model="query.Search" @keydown.enter="getListOfDocumentsLiveView"
            ...
            <button @click="getListOfDocumentsLiveView"
        ...
        <div>
            <div class="relative inline-block mr-4 mb-2">
                <select id="dropdown"
                    ...
                    v-model="query.Status" @change="getListOfDocumentsLiveView" @focus="isStatusOpen = true"
