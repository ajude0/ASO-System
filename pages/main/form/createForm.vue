<template>
    ...
    <ul class="p-4 flex flex-wrap space-x-3 text-sm font-medium">
      ...
      <li class="flex items-center space-x-3" aria-current="page">
        ...
        <span class="flex items-center space-x-1">
          ...
          <span class="text-gray-400">Create Form</span>
        </span>
      </li>
    </ul>
  </nav>
  <div class="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <div class="mt-1 mb-10">
      <button @click="addFormObject" class="text-green-500">+ Add Section</button>
    </div>
    <div class="mb-6 p-4 border rounded bg-gray-50">
      <h2 class="font-semibold mb-4">Approvers <span class="text-red-500 text-sm"> * </span></h2>
